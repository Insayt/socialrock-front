    ...
    methods: {
      ...
      addAccount (type) {
        ...
        this.popup = this.PopupCenter(
          ...
          `https://oauth.vk.com/authorize?client_id=${process.env.VUE_APP_VK_ID_APP}&redirect_uri=${process.env.VUE_APP_VK_ID_APP_REDIRECT}&scope=groups,offline,wall,stats,photo&response_type=code&state=${payload}&v=5.37&revoke=1`,
          'authvk',
          700,
          500
        );
